...
export class TestService {
    ...
    setSubMap(): void {
        ...
        this.subMap.set("sp", {id: "sp", name: "맞춤법",   num: 1});
        this.subMap.set("sl", {id: "sl", name: "표준어",   num: 2});
        this.subMap.set("lw", {id: "lw", name: "외래어",   num: 3});
        this.subMap.set("kr", {id: "kr", name: "어휘",     num: 4});
        this.subMap.set("cc", {id: "cc", name: "한자",   num: 5});
        this.subMap.set("c4", {id: "c4", name: "한자성어", num: 6});
        this.subMap.set("ew", {id: "ew", name: "영단어",   num: 7});
    }
